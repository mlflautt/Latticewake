...
.PHONY: test clean sanitizer swift-test scripts-check package bundle-verify verify-release crash-baseline crash-smoke crash-report close-apps launch-exact launch-review
...
scripts-check:
	...
	zsh -n scripts/close_latticewake_instances.sh

close-apps:
	zsh scripts/close_latticewake_instances.sh
