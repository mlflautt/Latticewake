...
void testRoleControlCanonicalBoundary() {
  ...
  assert(repeated.enabled == 0U);
  assert(repeated.density == 0.75F);
  assert(repeated.variation == 0.5F);
  assert(repeated.seed_offset == 99U);
  assert(repeated.pattern == 5U);
